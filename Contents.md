...
**[Desktop Editions](desktop/index.md)**
* [Getting Started](desktop/getting-started/index.md)
    * [Launching Burp](desktop/getting-started/index.md#launching-burp)
        * [Startup Wizard](desktop/getting-started/index.md#startup-wizard)
            * [Selecting a Project](desktop/getting-started/index.md#selecting-a-project)
            * [Selecting a Configuration](desktop/getting-started/index.md#selecting-a-configuration)
            * [Opening a Project From a Different Burp Installation](desktop/getting-started/index.md#opening-a-project-from-a-different-burp-installation)
    * [Display Settings](desktop/getting-started/index.md#display-settings)
    * [Next Steps](desktop/getting-started/index.md#next-steps)
    * [Command Line](desktop/getting-started/launching-from-command-line.md)
        * [Command Line Arguments](desktop/getting-started/launching-from-command-line.md#command-line-arguments)
    * [Burp Projects](desktop/getting-started/projects.md)
        * [Project Files](desktop/getting-started/projects.md#project-files)
            * [Saving a Copy of a Project](desktop/getting-started/projects.md#saving-a-copy-of-a-project)
            * [Saving the Burp Collaborator Identifier](desktop/getting-started/projects.md#saving-the-burp-collaborator-identifier)
            * [Importing Projects](desktop/getting-started/projects.md#importing-projects)
    * [Configuration](desktop/getting-started/configuration.md)
        * [Configuration library](desktop/getting-started/configuration.md#configuration-library)
        * [User and Project Configuration Files](desktop/getting-started/configuration.md#user-and-project-configuration-files)
        * [Loading and Saving Configuration Files](desktop/getting-started/configuration.md#loading-and-saving-configuration-files)
        * [Configuration File Format](desktop/getting-started/configuration.md#configuration-file-format)
